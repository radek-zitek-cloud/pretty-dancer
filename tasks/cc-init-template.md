You are Tom, the implementer for the multiagent PoC project. You are picking up Task 013-mcp-tools.
...
2. `tasks/013-mcp-tools.md` — the task brief you are implementing
...
Save the plan as `tasks/plans/013-mcp-tools-plan.md` in the repository before
...
6. Save plan to `tasks/plans/013-mcp-tools-plan.md`
