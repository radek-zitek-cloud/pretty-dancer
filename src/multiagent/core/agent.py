# pyright: reportUnknownMemberType=false, reportUnusedImport=false, reportUnknownArgumentType=false, reportCallIssue=false
...
from multiagent.core.state import AgentState
...
class LLMAgent:
    ...
    is exactly one method: ``run(input_text) -> str``. No I/O, no transport,
